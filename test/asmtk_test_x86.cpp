...
static const TestEntry testEntries[] = {
  ...
  X86_PASS(0x0000000000000000, "\x62\xF1\xF5\xD9\x58\x05\x00\x00\x00\x00"         , "vaddpd zmm0 {k1}{z}, zmm1, [rax] {1tox}"),
  ...
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6C"                                     , "rep   insb  byte  ptr es:[di], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6D"                                     , "rep   insd  dword ptr es:[di], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6E"                                     , "rep   outsb dx, byte  ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6F"                                     , "rep   outsd dx, dword ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA4"                                     , "rep   movsb byte  ptr es:[di], byte  ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA5"                                     , "rep   movsd dword ptr es:[di], dword ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA6"                                     , "repe  cmpsb byte  ptr [si], byte  ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA7"                                     , "repe  cmpsd dword ptr [si], dword ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAA"                                     , "rep   stosb byte  ptr es:[di], al"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAB"                                     , "rep   stosd dword ptr es:[di], eax"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAC"                                     , "rep   lodsb al , byte  ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAD"                                     , "rep   lodsd eax, dword ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAE"                                     , "repe  scasb al , byte  ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAF"                                     , "repe  scasd eax, dword ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x6C"                                         , "repne insb  byte ptr es:[edi], dx"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\x6D"                                     , "repne insw  word ptr es:[edi], dx"),
  X86_PASS(0x000000009123ffe1, "\xF2\x6E"                                         , "repne outsb dx, byte ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\x6F"                                     , "repne outsw dx, word ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\xA4"                                         , "repne movsb byte ptr es:[edi], byte ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\xA5"                                     , "repne movsw word ptr es:[edi], word ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\xA6"                                         , "repne cmpsb byte ptr [esi], byte ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\xA7"                                     , "repne cmpsw word ptr [esi], word ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\xAA"                                         , "repne stosb byte ptr es:[edi], al"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\xAB"                                     , "repne stosw word ptr es:[edi], ax"),
  X86_PASS(0x000000009123ffe1, "\xF2\xAC"                                         , "repne lodsb al, byte ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\xAD"                                     , "repne lodsw ax, word ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\xAE"                                         , "repne scasb al, byte ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF2\x66\xAF"                                     , "repne scasw ax, word ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6C"                                     , "rep   insb  byte ptr es:[di], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\x6D"                                 , "rep   insw  word ptr es:[di], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\x6E"                                     , "rep   outsb dx, byte ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\x6F"                                 , "rep   outsw dx, word ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA4"                                     , "rep   movsb byte ptr es:[di], byte ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\xA5"                                 , "rep   movsw word ptr es:[di], word ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xA6"                                     , "repe  cmpsb byte ptr [si], byte ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\xA7"                                 , "repe  cmpsw word ptr [si], word ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAA"                                     , "rep   stosb byte ptr es:[di], al"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\xAB"                                 , "rep   stosw word ptr es:[di], ax"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAC"                                     , "rep   lodsb al, byte ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\xAD"                                 , "rep   lodsw ax, word ptr [si]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x67\xAE"                                     , "repe  scasb al, byte ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x66\x67\xAF"                                 , "repe  scasw ax, word ptr es:[di]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x6C"                                         , "rep   insb  byte  ptr es:[edi], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x6D"                                         , "rep   insd  dword ptr es:[edi], dx"),
  X86_PASS(0x000000009123ffe1, "\xF3\x6E"                                         , "rep   outsb dx, byte  ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\x6F"                                         , "rep   outsd dx, dword ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xA4"                                         , "rep   movsb byte  ptr es:[edi], byte  ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xA5"                                         , "rep   movsd dword ptr es:[edi], dword ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xA6"                                         , "repe  cmpsb byte  ptr [esi], byte  ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xA7"                                         , "repe  cmpsd dword ptr [esi], dword ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAA"                                         , "rep   stosb byte  ptr es:[edi], al"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAB"                                         , "rep   stosd dword ptr es:[edi], eax"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAC"                                         , "rep   lodsb al , byte  ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAD"                                         , "rep   lodsd eax, dword ptr [esi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAE"                                         , "repe  scasb al , byte  ptr es:[edi]"),
  X86_PASS(0x000000009123ffe1, "\xF3\xAF"                                         , "repe  scasd eax, dword ptr es:[edi]"),

  // 32-bit malformed input - should cause either parsing or validation error.
  X86_FAIL(0x0000000000405C23, "MOV EAX, DWORD PTR ]["),
  X86_FAIL(0x0000000000405C23, "MOV EAX, DWORD PTR [RAX]"),
  X86_FAIL(0x0000000000405C23, "MOV EAX, DWORD PTR [0xFFFFFFFFF]"),
};
